...
?>
			...
			<input type="submit" id="submit_buy" class="btn btn-danger btn-block" value="立即购买">
		</div>
   ...
   <div class="col-sm-12 col-md-6"> 
    <div class="panel panel-primary"> 
     ...
     <a data-toggle="modal" href="./user/reg.php?kind=0" target="_blank" class="list-group-item list-group-item-info text-center"><strong>马上开通</strong></a> 
    </div> 
   </div> 
   <div class="col-sm-12 col-md-6"> 
    <div class="panel panel-primary"> 
     ...
     <a data-toggle="modal" href="./user/reg.php?kind=1" target="_blank" class="list-group-item list-group-item-info text-center"><strong>马上开通</strong></a> 
    </div> 
   </div> 
  </div> 
</div>
